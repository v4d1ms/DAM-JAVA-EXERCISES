...
public class Principal {
	...
	public static void escribirMenuOpciones() {
		...
		System.out.println("(10) Consultar los compradores que incluyan una ciudad en la dirección de envío.");
		System.out.println("(11) Consultar los compradores con la lista de productos favoritos más larga");
		System.out.println("(15) Añadir un producto a la lista de favoritos de un comprador, por correo.");
		System.out.println();
	}
		...
		do {
			...
			case 1:
				...
				if (usuario == null) {
					...
					contrasegna = Teclado.leerCadena("¿Contraseña? ");
					categoria = Teclado.leerCadena("¿Categoría? ");
			...
			// Consultar los compradores con la lista de productos favoritos más larga
			case 11:
			...
			// Añadir un producto a la lista de favoritos de un comprador, por correo
			case 15:
				correo = Teclado.leerCadena("¿Correo? ");
				usuario = coleccion.consultarPorCorreo(correo);
				if (usuario == null) {
					System.out.println("No hay ningún usuario con ese correo.");
				}
