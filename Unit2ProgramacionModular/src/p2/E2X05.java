...
public class E2X05 {
	...
	public static void main(String[] args) {
		...
		while (opcion != 0) {			
			...
			System.out.println("1) Dibujar triangulo Izquierda e invertido");
			System.out.println("2) Dibujar triangulo Derecha e invertido");
			System.out.println("3) Dibujar triangulo Centro e invertido");
